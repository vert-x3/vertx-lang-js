...
ServerWebSocketStream._jclass = utils.getJavaClass("io.vertx.core.http.ServerWebSocketStream");
ServerWebSocketStream._jtype = {
  accept: function(obj) {
    return ServerWebSocketStream._jclass.isInstance(obj._jdel);
  },
  wrap: function(jdel) {
    var obj = Object.create(ServerWebSocketStream.prototype, {});
    ServerWebSocketStream.apply(obj, arguments);
    return obj;
  },
  unwrap: function(obj) {
    return obj._jdel;
...
ServerWebSocketStream._create = function(jdel) {
  var obj = Object.create(ServerWebSocketStream.prototype, {});
  ServerWebSocketStream.apply(obj, arguments);
  return obj;
}
