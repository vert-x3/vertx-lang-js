...
var EventBus = function(j_val) {
  ...
  this.sender = function() {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      ...
      return utils.convReturnVertxGen(MessageProducer, j_eventBus["sender(java.lang.String,io.vertx.core.eventbus.DeliveryOptions)"](__args[0], __args[1] != null ? new DeliveryOptions(new JsonObject(JSON.stringify(__args[1]))) : null), undefined);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.publisher = function() {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      ...
      return utils.convReturnVertxGen(MessageProducer, j_eventBus["publisher(java.lang.String,io.vertx.core.eventbus.DeliveryOptions)"](__args[0], __args[1] != null ? new DeliveryOptions(new JsonObject(JSON.stringify(__args[1]))) : null), undefined);
    } else throw new TypeError('function invoked with invalid arguments');
  };
