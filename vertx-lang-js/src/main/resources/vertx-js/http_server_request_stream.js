...
HttpServerRequestStream._jclass = utils.getJavaClass("io.vertx.core.http.HttpServerRequestStream");
HttpServerRequestStream._jtype = {
  accept: function(obj) {
    return HttpServerRequestStream._jclass.isInstance(obj._jdel);
  },
  wrap: function(jdel) {
    var obj = Object.create(HttpServerRequestStream.prototype, {});
    HttpServerRequestStream.apply(obj, arguments);
    return obj;
  },
  unwrap: function(obj) {
    return obj._jdel;
...
HttpServerRequestStream._create = function(jdel) {
  var obj = Object.create(HttpServerRequestStream.prototype, {});
  HttpServerRequestStream.apply(obj, arguments);
  return obj;
}
