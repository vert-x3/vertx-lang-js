...
var WebSocketStream = function(j_val) {
  ...
  this.handler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      ...
      handler(utils.convReturnVertxGen(WebSocket, jVal));
    });
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
...
WebSocketStream._jclass = utils.getJavaClass("io.vertx.core.http.WebSocketStream");
WebSocketStream._jtype = {
  accept: function(obj) {
    return WebSocketStream._jclass.isInstance(obj._jdel);
  },
  wrap: function(jdel) {
    var obj = Object.create(WebSocketStream.prototype, {});
    WebSocketStream.apply(obj, arguments);
    return obj;
  },
  unwrap: function(obj) {
    return obj._jdel;
...
WebSocketStream._create = function(jdel) {
  var obj = Object.create(WebSocketStream.prototype, {});
  WebSocketStream.apply(obj, arguments);
  return obj;
}
