...
var FileSystem = function(j_val) {
  ...
  this.openBlocking = function(path, options) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && (typeof __args[1] === 'object' && __args[1] != null)) {
      return utils.convReturnVertxGen(AsyncFile, j_fileSystem["openBlocking(java.lang.String,io.vertx.core.file.OpenOptions)"](path, options != null ? new OpenOptions(new JsonObject(JSON.stringify(options))) : null));
    } else throw new TypeError('function invoked with invalid arguments');
  };
