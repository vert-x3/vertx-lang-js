...
var Vertx = function(j_val) {
  ...
  this.createNetServer = function() {
    ...
    if (__args.length === 0) {
      ...
      return utils.convReturnVertxGen(NetServer, j_vertx["createNetServer(io.vertx.core.net.NetServerOptions)"](__args[0] != null ? new NetServerOptions(new JsonObject(JSON.stringify(__args[0]))) : null));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.createNetClient = function() {
    ...
    if (__args.length === 0) {
      ...
      return utils.convReturnVertxGen(NetClient, j_vertx["createNetClient(io.vertx.core.net.NetClientOptions)"](__args[0] != null ? new NetClientOptions(new JsonObject(JSON.stringify(__args[0]))) : null));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.createHttpServer = function() {
    ...
    if (__args.length === 0) {
      ...
      return utils.convReturnVertxGen(HttpServer, j_vertx["createHttpServer(io.vertx.core.http.HttpServerOptions)"](__args[0] != null ? new HttpServerOptions(new JsonObject(JSON.stringify(__args[0]))) : null));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.createHttpClient = function() {
    ...
    if (__args.length === 0) {
      ...
      return utils.convReturnVertxGen(HttpClient, j_vertx["createHttpClient(io.vertx.core.http.HttpClientOptions)"](__args[0] != null ? new HttpClientOptions(new JsonObject(JSON.stringify(__args[0]))) : null));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.createDatagramSocket = function() {
    ...
    if (__args.length === 0) {
      ...
      return utils.convReturnVertxGen(DatagramSocket, j_vertx["createDatagramSocket(io.vertx.core.datagram.DatagramSocketOptions)"](__args[0] != null ? new DatagramSocketOptions(new JsonObject(JSON.stringify(__args[0]))) : null));
    } else throw new TypeError('function invoked with invalid arguments');
  };
...
Vertx.vertx = function() {
  ...
  if (__args.length === 0) {
    ...
    return utils.convReturnVertxGen(Vertx, JVertx["vertx(io.vertx.core.VertxOptions)"](__args[0] != null ? new VertxOptions(new JsonObject(JSON.stringify(__args[0]))) : null));
  } else throw new TypeError('function invoked with invalid arguments');
};
