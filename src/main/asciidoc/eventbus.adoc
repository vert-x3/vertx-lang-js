...
`link:dataobject/DeliveryOptions.html[DeliveryOptions]` when sending or publishing:
...
When sending a message with a reply handler you can specify a timeout in the `link:dataobject/DeliveryOptions.html[DeliveryOptions]`.
