...
The link:dataobject/VertxOptions.html[`VertxOptions`] object has many settings and allows you to configure things like clustering,
...
link:dataobject/VertxOptions.html[`VertxOptions`] object before creating the Vertx object.
...
If you want to deploy a verticle as a worker verticle you do that with link:dataobject/DeploymentOptions.html#setWorker[`setWorker`].
...
Extra classpath entries can also be provided with link:dataobject/DeploymentOptions.html#setExtraClasspath[`setExtraClasspath`] so they
