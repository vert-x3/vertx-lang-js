...
If you don't want the default, a server can be configured by passing in a link:jsdoc/net_server_options-NetServerOptions.html[`NetServerOptions`]
...
If you don't want the default, a client can be configured by passing in a link:jsdoc/net_client_options-NetClientOptions.html[`NetClientOptions`]
instance when creating it:
...
This is configured with link:jsdoc/net_client_options-NetClientOptions.html#setReconnectInterval[`setReconnectInterval`] and
link:jsdoc/net_client_options-NetClientOptions.html#setReconnectAttempts[`setReconnectAttempts`].
...
the link:jsdoc/net_client_options-NetClientOptions.html[`NetClientOptions`] or link:jsdoc/net_server_options-NetServerOptions.html[`NetServerOptions`] instances used
to create the servers or clients.

==== Enabling SSL/TLS on the server

SSL/TLS is enabled with  link:jsdoc/net_server_options-NetServerOptions.html#setSsl[`setSsl`].
