...
closed after an idle time, then you configure `link:../cheatsheet/HttpServerOptions.html#setIdleTimeout[setIdleTimeout]`.
...
To enable compression use can configure it with `link:../cheatsheet/HttpServerOptions.html#setCompressionSupported[setCompressionSupported]`.
...
To enable compression set `link:../cheatsheet/HttpClientOptions.html#setTryUseCompression[setTryUseCompression]` on the options
...
For pooling to work, keep alive must be true using `link:../cheatsheet/HttpClientOptions.html#setKeepAlive[setKeepAlive]`
...
The maximum number of connections to pool *for each server* is configured using `link:../cheatsheet/HttpClientOptions.html#setMaxPoolSize[setMaxPoolSize]`
...
To enable pipe-lining, it must be enabled using `link:../cheatsheet/HttpClientOptions.html#setPipelining[setPipelining]`.
...
`link:../cheatsheet/HttpClientOptions.html#setMaxWebsocketFrameSize[setMaxWebsocketFrameSize]`
