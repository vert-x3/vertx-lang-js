...
You can set an `link:../../jsdoc/module-vertx-js_http_server-HttpServer.html#exceptionHandler[exceptionHandler]` to receive any
exceptions that happens before the connection is passed to the `link:../../jsdoc/module-vertx-js_http_server-HttpServer.html#requestHandler[requestHandler]`
or to the `link:../../jsdoc/module-vertx-js_http_server-HttpServer.html#websocketHandler[websocketHandler]`, e.g during the TLS handshake.
