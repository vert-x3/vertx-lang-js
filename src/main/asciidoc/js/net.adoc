...
This is configured with `link:../cheatsheet/NetClientOptions.html#setReconnectInterval[setReconnectInterval]` and
`link:../cheatsheet/NetClientOptions.html#setReconnectAttempts[setReconnectAttempts]`.
...
SSL/TLS is enabled with  `link:../cheatsheet/NetServerOptions.html#setSsl[ssl]`.
...
trust store location is set by using the function `link:../cheatsheet/JksOptions.html#setPath[path]` on the
...
`link:../cheatsheet/JksOptions.html#setPath[path]` on the
...
longer be trusted. The `link:../cheatsheet/NetClientOptions.html#addCrlPath[crlPath]` configures
the crl list to use:
