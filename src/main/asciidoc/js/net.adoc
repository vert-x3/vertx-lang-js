...
Files and classpath resources can be written to the socket directly using `link:../../jsdoc/net_socket-NetSocket.html#sendFile[sendFile]`. This can be a very
...
OpenSSL requires to configure `link:../dataobjects.html#TCPSSLOptions#setSslEngine[sslEngine]` to `link:todo[OPENSSL]`
