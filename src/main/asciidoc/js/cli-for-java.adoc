...
and `TypedArgument` in the `link:../../jsdoc/module-vertx-js_cli-CLI.html[CLI]` definition:
...
Once annotated, you can define the `link:../../jsdoc/module-vertx-js_cli-CLI.html[CLI]` and inject the values using:
