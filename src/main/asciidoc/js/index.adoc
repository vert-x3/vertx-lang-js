...
Coordination of multiple asynchronous results can be achieved with Vert.x `link:../../jsdoc/module-vertx-js_future-Future.html[futures]`.
...
The handler returned by `link:../../jsdoc/module-vertx-js_future-Future.html#completer[completer]` completes the future.

`link:../../jsdoc/module-vertx-js_composite_future-CompositeFuture.html#any[CompositeFuture.any]` takes several futures arguments (up to 6) and returns a future that is
...
`link:../../jsdoc/module-vertx-js_future-Future.html#compose[compose]` can be used for chaining futures:
