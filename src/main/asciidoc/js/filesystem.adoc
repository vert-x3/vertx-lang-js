...
The Vert.x `link:../../jsdoc/module-vertx-js_file_system-FileSystem.html[FileSystem]` object provides many operations for manipulating the file system.

There is one file system object per Vert.x instance, and you obtain it with  `link:../../jsdoc/module-vertx-js_vertx-Vertx.html#fileSystem[fileSystem]`.
...
please consult the `link:../../jsdoc/module-vertx-js_file_system-FileSystem.html[API docs]` for the full list.
...
You open an `link:../../jsdoc/module-vertx-js_async_file-AsyncFile.html[AsyncFile]` as follows:
...
`link:../../jsdoc/module-vertx-js_async_file-AsyncFile.html#write[write]` method.
...
`link:../../jsdoc/module-vertx-js_async_file-AsyncFile.html#read[read]`
method.
...
cache by calling the `link:../../jsdoc/module-vertx-js_async_file-AsyncFile.html#flush[flush]` method.
...
This caching behaviour can be set on the `link:../dataobjects.html#VertxOptions#setFileResolverCachingEnabled[fileResolverCachingEnabled]`
...
To close an `AsyncFile` call the `link:../../jsdoc/module-vertx-js_async_file-AsyncFile.html#close[close]` method. Closing is asynchronous and
