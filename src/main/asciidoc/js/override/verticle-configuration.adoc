...
NOTE: The access to the `context` object is made either using `link:../../jsdoc/vertx-Vertx.html#currentContext[Vertx.currentContext]` or using
`link:../../jsdoc/vertx-Vertx.html#getOrCreateContext[getOrCreateContext]`.
