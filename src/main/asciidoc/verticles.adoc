...
They can implement it directly if you like but usually it's easier to extend the abstract class link:jsdoc/abstrac_verticle-AbstractVerticle.html[`AbstractVerticle`].
